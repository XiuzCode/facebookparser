...
class People(Pewaris):
	...
	def send_msg(self, msg):
		return action.people.send_msg(self.ses, self.id, msg)

	def list_friend(self):
		return self.list_friend_(self.ses, self.id)

	def unfriend(self):
		return action.people.unfriend(self.ses, self.id)

	def follow(self):
		return action.people.follow(self.ses, self.id)

	def unfollow(self):
		return action.people.unfollow(self.ses, self.id)
...
class Group(Pewaris):
	...
	def join_group(self):
		return action.group.join_group(self.ses, self.id)

	def leave_group(self):
		return action.group.leave_group(self.ses, self.id)
...
class Fanspage(Pewaris):
	...
	def like(self):
		return action.fanspage.like(self.ses, self.username)

	def unlike(self):
		return action.fanspage.unlike(self.ses, self.username)

	def follow(self):
		return action.fanspage.follow(self.ses, self.username)

	def unfollow(self):
		return action.fanspage.unfollow(self.ses, self.username)

	def send_msg(self, msg):
		return action.fanspage.send_msg(self.ses, self.username, msg)
